...
The same as GEANT4-MinimalExample1-CompileRunWithEclipse but refactored into C++17 code, in particular: unique pointers are used instead of raw pointers with new and delete operators.
